...
class TalentOrganizerHomeTest extends StatefulWidget {
  const TalentOrganizerHomeTest({super.key});

  @override
  State<TalentOrganizerHomeTest> createState() =>
      _TalentOrganizerHomeTestState();
}

class _TalentOrganizerHomeTestState extends State<TalentOrganizerHomeTest> {
  int _currentIndex = 0;
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  videoMetrics(
                                      theIcon: Iconsax.heart,
                                      theText: "66k",
                                      onTap: () {}),
                                  videoMetrics(
                                      theIcon: Iconsax.messages_3,
                                      theText: "22k",
                                      onTap: () {
...
// using this will make the page scrollable after the end of the home video contents  container      
//// ...filteredVideos.map((vl) => Container(
        //       height: 400,
        //       width: double.infinity,
        //       margin: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 10),
        //       // ...your video card widget here...
        //     )